# lcjs-example-0023-decayingLineChart

Refreshing line chart application, where some amount of previous samples are left visible for a brief moment.
...
```
cd existing_repo
git remote add origin https://gitlab.com/arction/lcjs/lcjs-examples/lcjs-example-0023-decayinglinechart.git
git branch -M master
